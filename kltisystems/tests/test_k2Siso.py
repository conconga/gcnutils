...
class TestClass_Example:
    ...
    def test_example_2order_siso(self):
        ...
        lti_free     = k2OrderLTIsysSisoFactory(qsi, wn, 0, -inf, inf, -inf, inf)
        lti_ratelim  = k2OrderLTIsysSisoFactory(qsi, wn, 0, -1.5, 1.5, -inf, inf)
        lti_statelim = k2OrderLTIsysSisoFactory(qsi, wn, 0, -inf, inf, -0.5, 0.5)
        lti_2lim     = k2OrderLTIsysSisoFactory(qsi, wn, 0, -1.7, 1.7, -0.5, 0.5)
        ...
        c      = k2OrderLTIsysSisoFactory(0.7, 2.*np.pi*20, -16, -11, 5, -15, 0)
        d      = k2OrderLTIsysSisoFactory(0.7, 2.*np.pi*20, -16, -11, 5, -15, 0, Ts=1./Fs)
        log_t2 = list()
