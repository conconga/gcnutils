...
signals. The 2-order filters allow to limit (up and down) both the output and
slopes. The N-order filter allow to estimate the derivative of any order fo the
input signal.
